...
気軽に対話システムや対話ロボットを作成するには，音声合成，音声認識，および電子回路（目が光る，頭が動く）を Scratch で使えるとよさそうです．それに，常にインターネットに接続できる環境にいるとは限らないので，すべてオフラインで行えるようにしたいところ．ここではそんな Scratch ブロックを紹介します．
...
必要な機能に応じて拡張ブロックを追加します．それぞれインストーラを準備しています． micro:bitの拡張ブロック s2microbit-ble は Mac OS X でも使えますが，他は今のところ Windowsのみです．[全体設計についてはこちらのページ](design.md)で詳しく説明しています．
